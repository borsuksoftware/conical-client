...
{
    public class TestRunAdditionalFileTests
    {
        [Fact]
        ...
        public async Task Download()
        {
            ...
            apiServiceMock.
                Setup(x => x.ProductTestRunSetTestRunAdditionalFileStream(productName, trsID, trID, fileName)).
            ...
            using (var stream = await testRunAdditionalFile.GetFileContents())
            {
